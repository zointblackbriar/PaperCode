...
export interface Receiver extends BaseContract {
  ...
  functions: {
    ...
    receiveGoods(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    receiveGoods(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    receiveGoods(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
