...
export interface APIConsumerInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "_link" | "fulfill" | "requestVolumeData" | "volume"
  ): FunctionFragment;

  encodeFunctionData(functionFragment: "_link", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_link", data: BytesLike): Result;
...
export interface APIConsumer extends BaseContract {
  ...
  functions: {
    _link(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    _link(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    _link(overrides?: CallOverrides): Promise<PopulatedTransaction>;
