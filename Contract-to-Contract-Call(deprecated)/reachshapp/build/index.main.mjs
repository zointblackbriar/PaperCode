...
export async function Role1(ctcTop, interact) {
  if (typeof(ctcTop) !== 'object' || ctcTop._initialize === undefined) {
    return Promise.reject(new Error(`The backend for Role1 expects to receive a contract as its first argument.`));}
  if (typeof(interact) !== 'object') {
    return Promise.reject(new Error(`The backend for Role1 expects to receive an interact object as its second argument.`));}
  ...
  const v61 = stdlib.protect(ctc0, interact.info, 'for Role1\'s interact field info');
  const v62 = stdlib.protect(ctc1, interact.request, 'for Role1\'s interact field request');
  ...
  const txn1 = await (ctc.sendrecv({
    ...
    sim_p: (async (txn1) => {
      ...
      const {data: [v66], secs: v68, time: v67, didSend: v28, from: v65 } = txn1;
  ...
  const {data: [], secs: v73, time: v72, didSend: v37, from: v71 } = txn2;
  ;
  const txn3 = await (ctc.sendrecv({
    ...
    sim_p: (async (txn3) => {
      ...
      const {data: [v79], secs: v81, time: v80, didSend: v46, from: v78 } = txn3;
  ...
  const {data: [v79], secs: v81, time: v80, didSend: v46, from: v78 } = txn3;
  ;
  const v82 = stdlib.addressEq(v65, v78);
  stdlib.assert(v82, {
...
export async function Role2(ctcTop, interact) {
  if (typeof(ctcTop) !== 'object' || ctcTop._initialize === undefined) {
    return Promise.reject(new Error(`The backend for Role2 expects to receive a contract as its first argument.`));}
  if (typeof(interact) !== 'object') {
    return Promise.reject(new Error(`The backend for Role2 expects to receive an interact object as its second argument.`));}
  const ctc = ctcTop._initialize();
  const stdlib = ctc.stdlib;
  ...
  stdlib.protect(ctc1, await interact.want(v66), {
    at: './index.rsh:26:20:application',
